...
var defaultHandler = (_req, _res, next) => next();
...
var clerkClient = new Proxy(clerkClientSingleton, {
  get(_target, property) {
    ...
    const client = (0, import_backend.createClerkClient)({ ...env, userAgent: `${"@clerk/express"}@${"1.0.1"}` });
    if (env.secretKey) {
...
`);
var middlewareNotInvoked = createErrorMessage(
...
var usedWithoutInvocation = (args) => {
  return args.length === 3 && typeof args[0] === "object" && typeof args[1] === "object" && typeof args[2] === "function";
};
...
var requireAuth = (request, _response, next) => {
